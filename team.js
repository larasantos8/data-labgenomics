export const team = {
    principal: {
        ...
        image: '/assets/images/team/marianaNery.png',
        name: 'Mariana Freitas Nery',
        email: 'marinery@unicamp.br',
        site: 'http://lattes.cnpq.br/1410858776932991',
    },
    posdoc_fellow: [
      {
    ...
    collaborators: [
      {
        name: 'Flávia Akemi Nitta Fernandes',
        degree: 'Master’s degree',
        site: 'http://lattes.cnpq.br/4326910987159123'
      },
      {
        name: 'Erica Martinha Silva de Souza',
        degree: 'Ph.D degree',
        site: 'http://lattes.cnpq.br/9530933208734813'
      },
      {
        name: 'Maria Luiza Andreani',
        degree: 'Master’s degree',
        site: '​​http://lattes.cnpq.br/1031570416362681'
      },
      {
        name: 'Bruna Cristina Dias',
        degree: 'Master’s degree',
        site: 'http://lattes.cnpq.br/7525609810215272'
      },
      {
        name: 'Felipe André Silva',
        degree: 'Master’s degree',
        site: 'http://lattes.cnpq.br/5292077779972313'
      },
      {
        name: 'Letícia Magpali Moura Estevão',
        degree: 'Undergrad Research and collaborator',
        site: 'http://lattes.cnpq.br/2690712248724754'
      },
      {
        name: 'Michelle Carneiro Rachid Ribeiro',
        degree: 'Undergrad Research',
        site: 'http://lattes.cnpq.br/7619019791980676'
      },
      {
        name: 'Agnello César Rios Picorelli',
        degree: 'Collaborator',
        site: 'http://lattes.cnpq.br/3037646281651484'
      },
      {
        name: 'Elisa Karen da Silva Ramos',
        degree: 'Ph.D degree',
        site: 'http://lattes.cnpq.br/7174591567628859'
      },
      {
        name: 'Lucas Araújo Freitas',
        degree: 'Pos-doc',
        site: 'http://lattes.cnpq.br/7158471076088943'
      },
      {
        name: 'Marcos Adriano Vaz Barbosa',
        degree: 'Undergrad Research',
        site: 'http://lattes.cnpq.br/3447371090950093'
      },
    ],
}